...
namespace Orleans.Samples.Chirper2012.Grains
{
    ...
    [Reentrant]
    public class ChirperAccount : GrainBase<IChirperAccountState>, IChirperAccount
    {
        [NonSerialized]
        ...
        public async Task FollowUserId(long userId)
        {
            ...
            string alias = await userToFollow.UserAlias;
        ...
        public async Task UnfollowUserId(long userId)
        {
            ...
            string alias = await userToUnfollow.UserAlias;
        ...
        {
            get { return Task.FromResult(State.UserId); }
        }

        public Task<string> UserAlias
        {
            get { return Task.FromResult(State.UserAlias); }
        }
